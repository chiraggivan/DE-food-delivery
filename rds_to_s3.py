    ...
    try:
        ...
        for table in tables:
            ...
            try:
                ...
                logger.info('Dataframe created from MySQL query.')
                ...
                if not df.empty:
                    ...
                    logger.info('Updated last extracted timestamp.')
                    ...
                    return {
                        "statusCode": 200,
                        "body": f"Uploaded {local_file} to s3://{TIMESTAMP_BUCKET}/{s3_key}"
                    }
                else:
                    logger.info('BUT Dataframe is empty. No new or updated data to extract.')
                    ...
                    return {
                        "statusCode": 200,
                        "body": "No new or updated data to extract."
                    }       
            except Exception as e:
